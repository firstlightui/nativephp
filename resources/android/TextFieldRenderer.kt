...
data class TextFieldRendererConfiguration(
    ...
    val showPasswordA11yLabel: String,
    val hidePasswordA11yLabel: String,
    val syncMode: String,
    ...
    constructor(node: NativeUINode) : this(
        ...
        clearA11yLabel = node.props.getString("clear_a11y_label").ifEmpty { "Clear text" },
        revealable = node.props.getBool("revealable"),
        showPasswordA11yLabel = node.props.getString("show_password_a11y_label").ifEmpty { "Show password" },
        hidePasswordA11yLabel = node.props.getString("hide_password_a11y_label").ifEmpty { "Hide password" },
