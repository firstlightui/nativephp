...
data class FeedbackCenterItemConfiguration(
    ...
    constructor(node: NativeUINode) : this(
        ...
        dismissLabel = node.props.getString("dismiss_label").ifEmpty { "Dismiss" },
        dismissA11yLabel = node.props.getString("dismiss_a11y_label").ifEmpty { "Dismiss feedback" },
