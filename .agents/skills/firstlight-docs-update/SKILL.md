...
2. Map changed paths through each page's `sources` metadata. Check ripples into component references, concepts, compatibility, installation, README, both indexes, `spec/documentation.json`, `spec/screenshots.json`, and docs skills.
