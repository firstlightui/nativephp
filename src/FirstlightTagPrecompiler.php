...
{
    private const FIRSTLIGHT_SELF_CLOSING_TAG = '~<\s*firstlight\s*:\s*(segmented|status-label|badge|button|icon-button|pill-group|choice-group|progress|activity-indicator|text-field|search-field|text-area|date-picker|time-picker|select|slider|stepper|switch|checkbox)(?=\s|/>)((?:[^>"\']|"[^"]*"|\'[^\']*\')*)/>~s';
